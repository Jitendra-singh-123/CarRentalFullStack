...
export class AdminService {
  ...
  ApiURLAdmins: string = 'https://localhost:44331/api/Admins';
  ApiURLCustomers: string = 'https://localhost:44331/api/Customers';
  ApiURLFeedbacks: string = 'https://localhost:44331/api/Feedbacks';
